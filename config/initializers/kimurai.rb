require 'kimurai/browser_builder/selenium_chrome_builder'

Kimurai.configure do |config|
  config.colorize_logger = false
  config.selenium_chrome_path = ENV.fetch('GOOGLE_CHROME_BIN', nil)
  config.chromedriver_path = ENV.fetch('CHROMEDRIVER_PATH', nil)
end

module Kimurai::BrowserBuilder
  SeleniumChromeBuilder.class_eval do
    def build
      # Register driver
